...
import com.soaic.network.cookie.CookiesManager;
import com.soaic.network.https.OkHttpSSLSocketFactory;
import com.soaic.network.interceptor.HeaderInterceptor;
import com.soaic.network.interceptor.HttpLoggingInterceptor;
import com.soaic.network.listener.OnResultListener;
import com.soaic.network.util.AppUtil;
...
public class NetClient{
    ...
    public <T> NetClient get(@NonNull Class<T> clazz, final OnResultListener<T> onResultListener){
    ...
    public <T> NetClient post(@NonNull Class<T> clazz, final OnResultListener<T> onResultListener){
        if (!AppUtil.isNetworkAvailable(mBuilder.context)) {
            handlerError(networkErrorException,onResultListener);
            return this;
        }
    ...
    public <T> NetClient postJSON(@NonNull Class<T> clazz, final OnResultListener<T> onResultListener){
        if (!AppUtil.isNetworkAvailable(mBuilder.context)) {
            handlerError(networkErrorException,onResultListener);
            return this;
        }
    ...
    public <T> NetClient postUpload(@NonNull Class<T> clazz, final OnResultListener<T> onResultListener){
        if (!AppUtil.isNetworkAvailable(mBuilder.context)) {
            handlerError(networkErrorException,onResultListener);
            return this;
        }
    ...
    public <T> NetClient put(@NonNull Class<T> clazz, final OnResultListener<T> onResultListener){
        if (!AppUtil.isNetworkAvailable(mBuilder.context)) {
            handlerError(networkErrorException,onResultListener);
            return this;
        }
    ...
    public <T> NetClient putUpload(@NonNull Class<T> clazz, final OnResultListener<T> onResultListener){
        if (!AppUtil.isNetworkAvailable(mBuilder.context)) {
            handlerError(networkErrorException,onResultListener);
            return this;
        }
    ...
    public <T> NetClient delete(@NonNull Class<T> clazz, final OnResultListener<T> onResultListener){
        if (!AppUtil.isNetworkAvailable(mBuilder.context)) {
            handlerError(networkErrorException,onResultListener);
            return this;
        }
